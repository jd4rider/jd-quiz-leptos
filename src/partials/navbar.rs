        ...
        <nav class="bg-gray-800">
              ...
              <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:ml-6 sm:block">
                  <div class="flex space-x-4">
                    ...
                    <span class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium"><A href="demo">"Demo"</A></span>
          ...
          <div class="sm:hidden" id="mobile-menu">
            <div class={move || mobile_menu_class.get()}>
              ...
              <a class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"><A href="demo">"Demo"</A></a>
